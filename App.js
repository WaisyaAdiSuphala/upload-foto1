  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <View>
            <Text style={styles.inputBox}>Waisya Adi Suphala</Text>
            <Text style={styles.inputBox}>1615051060</Text>
            <Text style={styles.inputBox}>PTI 4A</Text>
        </View>
        
        <View style={styles.buttoninduk}>
          <TouchableOpacity
            style={styles.button}
